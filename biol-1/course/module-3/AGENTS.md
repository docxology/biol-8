...
- **Lab Protocols**: `sample_lab-protocol.md` (or `module-3-lab-[number]-[topic].md`)
- **Lecture Content**: `sample_lecture-content.md` (or `module-3-lecture-[topic].md`)
- **Study Guides**: `sample_study-guide.md` (or `module-3-study-guide.md`)
