...
Technical documentation for course-level file processing, organization, and workflow management for BIOL-1 course materials.
...
4. Update Canvas if materials already uploaded
