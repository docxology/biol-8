...
This directory contains all public course materials for BIOL-1 (Biology 1 at Pelican Bay Prison, Spring 2026), organized by module. All materials in this directory are suitable for upload to Canvas and distribution to students.
...
- [Module 1](module-1/) - Introduction to Biology
- [Module 2](module-2/) - Cell Biology
...
5. **Interactive Questions** (`questions/questions.json`)
   - Interactive questions for engagement and assessment
   - JSON format with multiple question types
   - Displayed on module website with full interactivity
...
Module websites are generated using:

- **Script**: `software/scripts/generate_module_website.py`
- **Function**: `process_module_website()` from `batch_processing` module
- **Outputs**: Enhanced HTML website with resizable components, collapsible sections, and interactive questions
