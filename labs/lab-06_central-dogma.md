...
- **Use a codon table** to identify amino acids.
- **Simulate a mutation** and observe its effect on the final protein.
...
| **Start codon** | AUG — signals the beginning of translation (Methionine) |
...
Before a cell divides, it must copy its DNA. **Helicase** unzips the strands, and **DNA Polymerase** builds new ones.
...
**Complementary New Strand (5' to 3'):**
{fill:text}
...
**Mutated DNA Codon:** `GTA`

**New mRNA Codon:** {fill:text}
