...
Your skeleton does far more than hold you upright — it protects organs, stores minerals, produces blood cells, and works with muscles to generate every movement you make. Today you will explore the human skeleton hands-on, learn to identify the major bones, and compare the human skeleton to at least one mammal skeleton available in the lab.
...
## Part 2: Skeleton Walk — Find the Bones

### 2A: Axial Skeleton (the central axis — skull, spine, rib cage)

**At the classroom skeleton, locate each bone. Then find it on your own body. Check each box when found on BOTH.**
...
- [ ] Occipital bone — back of skull; feel the bump at the base
...
- [ ] Sacrum — flat triangular bone between hip bones at the back
...
### 2B: Appendicular Skeleton (limbs and girdles)
...
- [ ] Radius — forearm, thumb side; rotates when you pronate/supinate
- [ ] Ulna — forearm, pinky side; the pointy elbow (olecranon process) is this bone
- [ ] Carpals — 8 small wrist bones
- [ ] Metacarpals — 5 palm bones; feel the knuckles on the back of your hand
...
- [ ] Patella — kneecap; feel it slide when knee is relaxed
- [ ] Tibia — shinbone; feel the sharp ridge on the front
- [ ] Fibula — lateral lower leg; feel the outer ankle bump (lateral malleolus)
- [ ] Calcaneus — heel bone (largest of the tarsals)
...
> Femur · Sternum · Clavicle · Occipital bone · Patella · Lumbar vertebra · Scapula · Sacrum

**3. You feel the pointy bump at your elbow when you bend your arm. Which bone, and which specific structure, is that?**
...
## Part 4: Human vs. Mammal Skeleton — Comparative Anatomy

> Mammals share a common vertebrate ancestor. The same bones appear in every mammal skeleton — modified for different lifestyles. This is the concept of **homology**.

**Mammal skeleton examined:** {fill:text}

Compare the two skeletons side by side. For each region, describe what you observe on the mammal and infer what it tells you about how that animal lives.
...
| Hindlimb / Hind foot | Flat-footed, large heel bone | {fill:text} | {fill:text} |
| Pelvis shape | Broad, basin-shaped | {fill:text} | {fill:text} |
...
<!-- lab:reflection -->
**12. Choose ONE bone you examined today. State its name, its division (axial or appendicular), the type of joint it forms (if any), and one clinical or functional reason it matters:**

Bone: {fill:text}

{fill:textarea rows=4}

**13. In what way did examining a real (or model) skeleton change or deepen your understanding compared to reading about bones in a textbook?**
...
*Lab 11 — BIOL-8: Human Biology | The Skeletal System*
