# Module 09: Inheritance (OpenStax Chapter 8) — Keys to Success
...
- Describe Mendel's experiments and his two laws
...
- Understand when independent assortment applies and its limitations
...
1. **Practice Punnett squares** extensively
2. **Learn genetics vocabulary** thoroughly
3. **Analyze pedigree examples** from different inheritance patterns
4. **Calculate ratios** for various cross types
5. **Connect concepts** to real genetic conditions
