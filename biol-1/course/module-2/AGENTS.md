...
- **Assignments**: `module-2-assignment-[number]-[description].md`
  - Example: `module-2-assignment-1-introduction.md`
  - Located in `assignments/` subdirectory
- **Lab Protocols**: `sample_lab-protocol.md` (or `module-2-lab-[number]-[topic].md`)
- **Lecture Content**: `sample_lecture-content.md` (or `module-2-lecture-[topic].md`)
- **Study Guides**: `sample_study-guide.md` (or `module-2-study-guide.md`)
